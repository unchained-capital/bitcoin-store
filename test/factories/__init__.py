...
class ProductItemReservationFactory(factory.alchemy.SQLAlchemyModelFactory):
    """Product Item factory."""

    # hack to generate product and id https://stackoverflow.com/a/51208287
    product_item = factory.SubFactory(ProductItemFactory)
    product_item_id = factory.LazyAttribute(lambda o: o.product_item.id)

    cart_id = factory.Faker("isbn13")
