...
- `bitcoinstore/initializers.py` now exists to define frequently used imports, variables, etc.
...
- `bitcoinstore/blueprints/` namespace has been removed
...
- Import `Redis` more efficiently in `bitcoinstore/extensions.py`
...
- Unnecessary `CELERY_TASK_LIST` comment in `bitcoinstore/app.py`, this was a left over copy / paste mishap
